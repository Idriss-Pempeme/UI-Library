...
export const LESSON_TYPES = [
  ...
  },
  {
    value: 'powerpoint',
    label: 'PowerPoint',
    icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" strokeWidth="0"><rect x="2" y="2" width="20" height="20" rx="2" fill="currentColor" opacity="0.15"/><text x="12" y="16" textAnchor="middle" fill="currentColor" fontSize="11" fontWeight="700" fontFamily="Arial, sans-serif">P</text></svg>',
    color: '#d44527',
    accept: '.ppt,.pptx'
  },
  {
  ...
  },
  {
    value: 'excel',
    label: 'Excel',
    icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" strokeWidth="0"><rect x="2" y="2" width="20" height="20" rx="2" fill="currentColor" opacity="0.15"/><text x="12" y="16" textAnchor="middle" fill="currentColor" fontSize="11" fontWeight="700" fontFamily="Arial, sans-serif">X</text></svg>',
    color: '#1d7044',
    accept: '.xls,.xlsx,.csv'
  },
  {
    value: 'word',
    label: 'Word',
    icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" strokeWidth="0"><rect x="2" y="2" width="20" height="20" rx="2" fill="currentColor" opacity="0.15"/><text x="12" y="16" textAnchor="middle" fill="currentColor" fontSize="11" fontWeight="700" fontFamily="Arial, sans-serif">W</text></svg>',
    color: '#2b5797',
    accept: '.doc,.docx'
  },
];
